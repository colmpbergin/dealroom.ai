...
# BigPawRides — Executive Summary

**Date:** 2026-03-21 | **Stage:** Pre-Seed | **Raise:** €100,000 SAFE at €1.8M
post-money cap | **Close:** Q1 2026

---

BigPawRides is Dublin's first dedicated large-dog taxi — a purpose-built van
service for the 15,000 households that Uber, Bolt, and every standard pet taxi
routinely refuses.
...
BigPawRides operates a purpose-built Transit Custom-size van fitted to K9
transport specification — loading ramp, secure crating, non-slip surfaces,
ventilation — driven by the founder. Large-breed acceptance is guaranteed on
every booking. No driver discretion. No refusals. Per-trip fee: €25–€50,
bookable via WhatsApp at launch.
...
- **SOM**: ~€70K/year by Year 3 — single operator reaching 1.3% of SAM;
  consistent with financial model break-even target
- **Growth**: Global pet transport CAGR 9.2% (Verified Market Research, 2024);
  Irish pet care market 6–9%/year (Euromonitor, 2025)

---

## Traction

We are pre-revenue. Here is what is validated:
...
Per-trip fee at €25–€50 (blended €35 average). Break-even at 99 trips/month
(~23/week). LTV per active customer: ~€1,225 over 5 years (6–10 trips/year × €35
× 5 years). Blended CAC: <€30 via vet referrals and Dublin dog Facebook groups.
LTV:CAC ratio: >40:1 — far above the 3:1 VC benchmark.

---

## Team

**Roland Tritsch — Founder & Operator.** Serial entrepreneur and business
founder. Large dog owner in Dublin. Lived this problem directly and personally.
The founder-driver model is intentional: in a trust-based service business,
quality is the product — and quality at launch requires the founder to drive.
Second driver is the first seed-stage hire.
...
1. **Demand ramp**: May be slower than modelled — mitigated by 24-month runway
   and a downside case that reaches break-even at Month 20+ without running out
   of cash
2. **Solo founder dependency**: Intentional for months 1–12; second driver is
   the first seed hire
3. **Commercial licensing**: Ireland-specific requirement not yet confirmed —
   solicitor consultation before launch
...
_Full data room available on request. Financial model (PDF) available at Stage 3
access. References available post-term sheet._
