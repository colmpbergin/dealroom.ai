...
- **Instrument**: TBD (likely SAFE or convertible note)
- **Valuation / Cap**: TBD
- **Timeline**: TBD
...
## Key Milestones This Round Enables
...
- **Stage focus**: Pre-seed angels, family offices, friends & family
- **Check size**: €10K–€50K per investor
- **Geography**: Dublin / Ireland based preferred (local market credibility)
- **Value-add needed**: Dublin network (vet/groomer introductions), consumer /
  pet industry experience, operations expertise
- **Specific targets**: Enterprise Ireland (HPSU or CSF), NDRC, Dublin angel
  syndicates, individual angels with pet / consumer background

## Strategic Priorities (Next 12 Months)

1. Launch operations and complete first 10 paying trips (proof of concept)
2. Build referral relationships with 3–5 Dublin vet clinics and 3–5 grooming
   salons
3. Reach 25+ trips/week consistently (approaching break-even)
4. Establish BigPawRides as the go-to large-dog transport brand in Dublin
